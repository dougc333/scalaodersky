...
def wordsFront(words:Array[String], n:Int):Array[String] = ???
...
def copyEndy(nums:Array[Int], count:Int):Array[Int] = ???
...
def matchUp(a:Array[String], b:Array[String]):Int = ???
...
def userCompare(aName:String, aId:Int, bName:String, bId:Int):Int = ???
...
def mergeTwo(a:Array[String], b:Array[String], n:Int):Array[String] = ???
...
def commonTwo(a:Array[String], b:Array[String]):Int = ???
