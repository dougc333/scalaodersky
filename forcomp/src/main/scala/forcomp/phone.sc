...
object phoneObj {
  println("Welcome to the Scala worksheet")       //> Welcome to the Scala worksheet
   ...
   val mn = Map('2'->"ABC",'3'->"DEF",'4'->"GHI",'5'->"JKL",'6'->"MNO",'7'->"PQRS",'8'->"TUV",'9'->"WXYZ")
                                                  //> mn  : scala.collection.immutable.Map[Char,String] = Map(8 -> TUV, 4 -> GHI, 
                                                  //| 9 -> WXYZ, 5 -> JKL, 6 -> MNO, 2 -> ABC, 7 -> PQRS, 3 -> DEF)
  
   val test = for((digit,str)<-mn) yield print("digit:"+digit)
                                                  //> digit:8digit:4digit:9digit:5digit:6digit:2digit:7digit:3test  : scala.collec
                                                  //| tion.immutable.Iterable[Unit] = List((), (), (), (), (), (), (), ())
   val test1 = for((digit,str)<-mn) yield print("str:"+str)
                                                  //> str:TUVstr:GHIstr:WXYZstr:JKLstr:MNOstr:ABCstr:PQRSstr:DEFtest1  : scala.col
                                                  //| lection.immutable.Iterable[Unit] = List((), (), (), (), (), (), (), ())
   
   val s = "asdfasdfasdf"                         //> s  : String = asdfasdfasdf
   val splitMe=for(ch<-s) yield print("ch:"+ch)   //> ch:ach:sch:dch:fch:ach:sch:dch:fch:ach:sch:dch:fsplitMe  : scala.collection.
                                                  //| immutable.IndexedSeq[Unit] = Vector((), (), (), (), (), (), (), (), (), (), 
                                                  //| (), ())
   val charCode:Map[Char,Char]=
      for((digit,str)<-mn; ltr<-str) yield ltr->digit
  ...
  wordCode("Java".toUpperCase)                    //> res0: String = 5282
  
    val in = Source.fromFile("/home/dc/Downloads/linuxwords.txt")
